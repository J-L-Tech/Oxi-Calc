...
subplot_3d(1,1,1)
plt.gca().set_xlabel(r'x3')
plt.gca().set_ylabel(r'y3')
plt.gca().set_zlabel(r'z3')
plt.title(r'Yeet3')
xyz=np.array([[9,10,10],[5,6,6],[1,2,2],])
ax3d().plot(xyz[:,0],xyz[:,1],xyz[:,2],linewidth=2)

fn=r'C:\Users\Joren\Desktop\RustDrawing\math-calc\example_data\Yeet3_graph'
